        ...
        <el-row>
            <el-col type="flex" class="row-bg" justify="center">
                <el-menu default-active="1" class="el-menu-demo" mode="horizontal" background-color="#54d9e0" text-color="#fff">
                    ...
                    <el-menu-item class="el-menu-width" v-if="isLogin" index="6"><a href="/user/account" class="nav-link"><i class="el-icon-setting"></i><span class="text">用户</span></a></el-menu-item>
